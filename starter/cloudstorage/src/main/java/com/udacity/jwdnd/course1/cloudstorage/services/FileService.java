...
public class FileService {
    ...
    public Integer createFile(FileDTO dto) throws IOException {
        return fileMapper.insert(
                new File(null, dto.getFileName(), dto.getContentType(), dto.getFileSize(), dto.getFileData().getBytes(),
    ...
    public Integer updateFile(FileDTO dto) throws IOException {
        return fileMapper.updateById(
                new File(dto.getFileId(), dto.getFileName(), dto.getContentType(), dto.getFileSize(), dto.getFileData().getBytes(),
                        userService.getCurrentUser().getUserId())
        );
    }
